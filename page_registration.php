		...
		<div class="container content">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<form class="reg-page" id="phase1Reg" method="post" action="page_confirm.php">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<input type="text" name = "affiliation" id = "affiliation" class="form-control margin-bottom-20" <?php if($flag==-1){echo "value = '" . $_SESSION['affiliation'] . "'";}?>>
							</div>
						</div>
