...
if(isset($_POST['email'])){
	$myquery = "SELECT ID FROM Phase1Registration WHERE Email = '".$_POST[email]."'";
...
if(isset($_POST['finalSubmit'])){
	$myquery = "INSERT INTO `Phase1Registration`(`FullName`, `Organisation`, `MembershipType`, `Affiliation`, `MembershipNumber`, `MembershipAge`, `Section`, `Email`, `FirstTime`, `VolunteerRoles`, `Expectations`, `Suggestions`) VALUES ('".$_SESSION['firstName'] . " " . $_SESSION['lastName']."','".$_SESSION['organisation']."','".$_SESSION['membershipType']."','".$_SESSION['affiliation']."','".$_SESSION['membershipNumber']."','".$_SESSION['membershipAge']."','".$_SESSION['section']."','".$_SESSION['email']."','".$_SESSION['Q1']."','".$_SESSION['Q2']."','".$_SESSION['Q3']."','".$_SESSION['Q4']."')";
	// echo "QUERY ".$myquery;
	if(mysqli_query($con, $myquery)){
		...
		//sendVerificationLink($_SESSION['name'], $_SESSION['verifiemail'], $verificationID);
		//echo "Adding";
	}
	else{
		$flag=-3;
				...
				<div class="col-md-10 col-md-offset-1">
					<form class="reg-page" id="phase1Reg" method="post" action="">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<label>Affiliation <span class="color-red">*</span></label>
								<input type="text" name = "affiliation" id = "affiliation" class="form-control margin-bottom-20" disabled value="<?php echo $_SESSION['affiliation'];?>">
							</div>
						</div>
						...
						<label>Had you been to a delegate for any previous IEEE R10 Congress? If yes, when and where ?</label>
						<input type="text" name = "Q1" id = "Q1" class="form-control margin-bottom-20" value="<?php echo $_SESSION['Q1'];?>"  disabled>

						<label>Can you kindly share your volunteer roles in IEEE ? <span class="color-red">*</span></label>
